...
import 'package:firebase_impl_app/utilities/dialogs/cannot_share_empty_note_dialog.dart';
import 'package:firebase_impl_app/utilities/generics/get_arguments.dart';
...
class _CreateUpdateNoteViewState extends State<CreateUpdateNoteView> {
  ...
  Future<CloudNote> createOrGetExistingCode(BuildContext context) async {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: FutureBuilder(
        future: createOrGetExistingCode(context),
            ...
            case ConnectionState.done:
              ...
              return TextField(
                ...
                decoration: InputDecoration(
                  hintText: 'Start typing yor note...',
                ),
              );
            default:
